(function (cfg) {
	...
	$(document).ready(function() {
		//we need to refresh the background if Popout elements' background color changes, 
		//such as with a hover event.
		$("a.pop").bind("mouseenter mouseleave click focusin focusout", draw);


		//Our canvas needs to grow with the document.
		//Again, excanvas.js doesn't like how jQuery handles the DOM, so we're doing it the
		//"hard" way.
